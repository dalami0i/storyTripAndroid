...
public class TotalPhotoRecyclerViewAdapter extends RecyclerView.Adapter<TotalPhotoRecyclerViewAdapter.ViewHolder> {
    public static final int VIEW_TYPE_ODD = 1;
    public static final int VIEW_TYPE_EVEN = 2;

    AttractionSimpleListSet totalPhotolistSet = new AttractionSimpleListSet();
    int diviceSizeW;
    ...
    public TotalPhotoRecyclerViewAdapter(Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final AttractionSimpleList attractionSimpleList = totalPhotolistSet.getItems().get(position);
        Log.e("Total onBindViewHolder", position + " | " + attractionSimpleList.getItems().get(0).getThumnailAddr());
    ...
    public int getItemCount() {
        return totalPhotolistSet.getItems().size();
    }
