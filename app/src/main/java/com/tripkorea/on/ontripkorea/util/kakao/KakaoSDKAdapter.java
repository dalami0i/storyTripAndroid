package com.tripkorea.on.ontripkorea.util.kakao;
    ...
    public ISessionConfig getSessionConfig() {
        ...
        return new ISessionConfig() {
            ...
            public AuthType[] getAuthTypes() {
                ...
                AuthType[] authTypes = new AuthType[] {AuthType.KAKAO_ACCOUNT};

                new LogManager().LogManager("카톡 로그인","KakaoSDKAdapter getAuthTypes | "+authTypes.getClass().getSimpleName()+"");
