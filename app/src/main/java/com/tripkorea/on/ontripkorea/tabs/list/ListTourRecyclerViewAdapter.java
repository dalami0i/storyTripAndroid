...
public class ListTourRecyclerViewAdapter extends RecyclerView.Adapter<ListTourRecyclerViewAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public ListTourRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_listitems, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final ListTourRecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        new LogManager().LogManager("좋아요 확인",attractionSimple.getName()+" : "+attractionSimple.isLiked());
                            ...
                            .enqueue(new Callback<ApiMessage>(){
                                ...
                                public void onResponse(Call<ApiMessage> call, Response<ApiMessage> response) {
                                    if (response.body() != null) {
                                        ...
                                        MainActivity.attractionList.getItems().get(pos).setLiked(false);
                                    } else {
                            ...
                            .enqueue(new Callback<ApiMessage>(){
                                ...
                                public void onResponse(Call<ApiMessage> call, Response<ApiMessage> response) {
                                    if (response.body() != null) {
                                        ...
                                        MainActivity.attractionList.getItems().get(pos).setLiked(true);
                                    } else {
...
//        RequestOptions myOptions = new RequestOptions().override(diviceSizeW, 900);
        ...
        holder.itemImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new LogManager().LogManager("ListItemTourRVAdapter","item clicked : "+attractionSimple.getIdx());
