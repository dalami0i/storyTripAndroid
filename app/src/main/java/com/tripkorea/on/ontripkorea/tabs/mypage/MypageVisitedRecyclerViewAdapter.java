...
public class MypageVisitedRecyclerViewAdapter extends RecyclerView.Adapter<MypageVisitedRecyclerViewAdapter.ViewHolder>{

    MainActivity context;
    ArrayList<AttractionSimple> itemList = new ArrayList<>();

    public MypageVisitedRecyclerViewAdapter(){}
    ...
    @NonNull
    @Override
    public MypageVisitedRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_mypage_list_item, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull MypageVisitedRecyclerViewAdapter.ViewHolder holder, int position) {
