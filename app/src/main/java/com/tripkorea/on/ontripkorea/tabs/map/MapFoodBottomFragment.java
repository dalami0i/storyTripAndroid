...
public class MapFoodBottomFragment extends Fragment {

    private MainActivity main;
    AttractionSimple attraction;


    public Fragment newInstanceMapFoodBottomFragment(AttractionSimple attraction, MainActivity main){
        this.attraction = attraction;
        new LogManager().LogManager("MapFoodBottomFragment","attraction.getName(): "+attraction.getName());
        new LogManager().LogManager("MapFoodBottomFragment","this.attraction.getName(): "+this.attraction.getName());
        this.main = main;
        return  new MapFoodBottomFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.rv_map_bottom_item, container, false);
        new LogManager().LogManager("MapFoodBottomFragment","onCreateView 생성 ");
...
//        RequestOptions myOptions = new RequestOptions().override(diviceSizeW, 900);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new LogManager().LogManager("MapFoodBottomFragment","item clicked : "+attraction.getIdx());
